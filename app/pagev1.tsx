      ...
      <section className="flex-1 flex items-center justify-center px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-14">
          ...
          <div className="space-y-4">
            <h1
              className="font-serif text-6xl md:text-8xl text-balance leading-tight tracking-tight animate-fade-in"
          ...
          {event.description && (
            <div className="relative">
              ...
              <p className="text-xl md:text-2xl text-slate-600 text-pretty max-w-3xl mx-auto leading-relaxed relative z-10">
                {event.description}
              </p>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-stretch pt-8">
            <div className="flex-1 max-w-xs group">
              <div className="h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="flex flex-col items-center gap-4 text-center">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: `${accentColor}15` }}>
                    <Calendar className="w-7 h-7" style={{ color: accentColor }} />
                  </div>
                  <div>
                    <p className="text-sm font-semibold mb-2 uppercase tracking-wider" style={{ color: primaryColor }}>Date</p>
            ...
            <div className="flex-1 max-w-xs group">
              <div className="h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <div>
                    <p className="text-sm font-semibold mb-2 uppercase tracking-wider" style={{ color: primaryColor }}>Time</p>
            ...
            <div className="flex-1 max-w-xs group">
              <div className="h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <div>
                    <p className="text-sm font-semibold mb-2 uppercase tracking-wider" style={{ color: primaryColor }}>Location</p>
          ...
          <div className="pt-16">
            <div className="max-w-xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 shadow-xl border border-white/20 space-y-6 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  <h2 className="font-serif text-3xl md:text-4xl tracking-tight" style={{ color: primaryColor }}>
                    Check Your Invitation
                  </h2>
                  <p className="text-slate-600 text-lg">Enter your name to find your personalized invitation</p>
                </div>
